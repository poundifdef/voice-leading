...
for (c = 0; c < combinations.length; c++) {
    ...
    note = getRoot(s[0]);
    octave = getOctave(s[0]);
    accidental = hasAccidental(s[0]) ? accidental_string[getAccidental(s[0])] : "=";
    console.log(accidental + note + octave_string[octave]);

    note = getRoot(a[0]);
    octave = getOctave(a[0]);
    accidental = hasAccidental(a[0]) ? accidental_string[getAccidental(a[0])] : "=";
    console.log(accidental + note + octave_string[octave]);

    note = getRoot(t[0]);
    octave = getOctave(t[0]);
    accidental = hasAccidental(t[0]) ? accidental_string[getAccidental(t[0])] : "=";
    console.log(accidental + note + octave_string[octave]);

    note = getRoot(b[0]);
    octave = getOctave(b[0]);
    accidental = hasAccidental(b[0]) ? accidental_string[getAccidental(b[0])] : "=";
    console.log(accidental + note + octave_string[octave]);

    console.log(']')
    console.log('[')
for (i = 0; i < 4; i++) {
    note = getRoot(combinations[c][i]);
    octave = getOctave(combinations[c][i]);
    accidental = hasAccidental(combinations[c][i]) ? accidental_string[getAccidental(combinations[c][i])] : "=";
